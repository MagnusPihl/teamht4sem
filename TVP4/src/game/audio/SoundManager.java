 ...
 * by Brackeen, David
 * www.brackeen.com
 * Listing 4.10 SoundManager.java, page 171-173
 *
 * @author LMK
 * @version 1.0
 *
...
public class SoundManager extends ThreadPool {
     ...
     */
    public SoundManager(AudioFormat audioFormat, int maxSimultaneousSounds) {
        super(Math.min(maxSimultaneousSounds, getMaxSimultaneousSounds(audioFormat)));
    ...
    /**
     * Forceably close the SoundManager
     */
    public void close() {
        cleanUp();
        super.close();
